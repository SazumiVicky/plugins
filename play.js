...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, wm.trim(), await( await conn.getFile(thumbnail)).data, [['Video', `.ytv ${vid.url}`]], false, { quoted: m, 'document': { 'url':'https://wa.me/+6285236226786' },
...
mediaUrl: `${url}`,
title: wm,
body: `Chotto matte kudasai, audio sedang dikirim...`,
sourceUrl: 'http://wa.me/+6285236226786', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
